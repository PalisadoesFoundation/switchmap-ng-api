# Switchmap-NG API Documentation Website

[![N|Solid](static/img/markdown/misc/logo.png)](https://github.com/PalisadoesFoundation/switchmap-ng-api)

# Installation

This document provides instructions on how to set up and start a running instance of switchmap-ng-api website on your local system. The instructions are written to be followed in sequence so make sure to go through each of them step by step without skipping any sections.

# Table of Contents

<!-- /TOC -->

- [Switchmap-NG API Documentation Website](#switchmap-ng-api-documentation-website)
...
The contents of the `switchmap-ng-api` repo is used to automatically create [the Switchmap-NG API Documentation website](https://switchmap-ng-api.switchmap-ng.io/). The automation uses [Docusaurus](https://docusaurus.io/docs/), a modern static website generator.
...
```console
$ git clone https://github.com/PalisadoesFoundation/switchmap-ng-api.git
$ cd switchmap-ng-api/docs
$ yarn add docusaurus
```
